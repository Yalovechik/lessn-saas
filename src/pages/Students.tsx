                                ...
                                {paginatedStudents.map((s) => {
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <td className="px-4 py-3">
                                                <span
                                                    className={`text-sm font-bold ${st.remaining <= 0 ? "text-coral" : st.remaining <= 2 ? "text-orange" : "text-mint-dark"}`}
                                                >
                                                    {st.remaining}
                                                </span>
                                            </td>
                                            ...
                                            >
                                                <div className="flex items-center gap-1">
                                                    <button
                                                        ...
                                                        className="p-2 min-w-[36px] min-h-[36px] flex items-center justify-center text-sm text-muted-foreground hover:text-foreground transition-colors rounded-md hover:bg-secondary"
                                                    >
                                                        ✏️
                                                    </button>
                                                    <button
                                                        ...
                                                        className="p-2 min-w-[36px] min-h-[36px] flex items-center justify-center text-sm text-coral hover:text-coral-dark transition-colors rounded-md hover:bg-coral-light"
                                                    >
                                                        🗑️
                                                    </button>
                                                </div>
